...
def display_chunks(chunks, frame):
    ...
    for i, chunk in enumerate(chunks, start=1):
        ...
        copy_button = tk.Button(frame, text="📋", command=lambda c=chunk: pyperclip.copy(c))
        ...
        copy_size_button = tk.Button(frame, text="📋", command=lambda s=chunk_size: pyperclip.copy(s))
